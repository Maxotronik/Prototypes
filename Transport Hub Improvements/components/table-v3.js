            ...
            card.innerHTML = `
                ...
                <div class="vehicle-card-left">
                    ...
                    <div class="vehicle-card-info">
                        ...
                        <div class="vehicle-card-orderid">Order #${vehicle.orderId}</div>
                ...
                <div class="vehicle-card-center">
                    ...
                    <div class="card-address-row">
                        <div class="card-address-item">
                            <span class="card-address-label">Pickup</span>
                            <span class="card-address-value">${vehicle.pickupLocType}</span>
                        </div>
                        <div class="card-address-spacer"></div>
                        <div class="card-address-spacer"></div>
                        <div class="card-address-item card-address-right">
                            <span class="card-address-label">Delivery</span>
                            <span class="card-address-value">${vehicle.deliveryLocType}</span>
                        </div>
                    </div>
                </div>
