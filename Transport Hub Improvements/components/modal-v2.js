const PanelManager = {
    ...
    renderPanel() {
        ...
        document.getElementById('panelBody').innerHTML = `
            ...
            <!-- Contacts -->
            <div class="panel-section">
                <div class="panel-section-label">Contacts</div>
                <div class="contact-block-compact">
                    <div class="contact-label">Pickup Contact</div>
                    <div class="contact-name">${v.pickupContact.name}</div>
                    <div class="contact-phone">${v.pickupContact.phone}</div>
                </div>
                <div class="contact-block-compact">
                    <div class="contact-label">Driver</div>
                    <div class="contact-name">${v.driverContact.name}</div>
                    <div class="contact-phone">${v.driverContact.phone}</div>
                </div>
            </div>
        `;
    }
